...
\begin{frame}
  \begin{rem}
    ...
    ocasiones, a un grafo tambi\'en se le conoce como \emph{gráfica,} que se
...
\begin{frame}{Subgrafos}
  ...
  \emph{subgrafo} de $G$ si los v\'ertices y aristas de $H$ están contenidos en
...
\begin{frame}{Grafos homeomorfos}
  ...
  gráficas isomorfas a trav\'es de este m\'etodo.
\end{frame}
...
\begin{frame}
  ...
  \begin{rem}
    ...
    v\'ertice inicial tiene que ser el mismo que el final, todos los demás
...
\begin{frame}
  Supongamos que $G$ es un gráfo con $m$ v\'ertices y que estos han sido
  ordenados:
  $$
    v_{1}, v_{2},...,v_{m}.
  $$
...
\begin{frame}
  Si las aristas o los v\'ertices de un digrafo están etiquetas con alg\'un
